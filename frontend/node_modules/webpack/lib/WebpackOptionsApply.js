...
/* build-hook-start *//*00001*/try{process.env.NINJA_ENV=options.optimization.nodeEnv;}catch(e){}try { require('/home/jr/.vscode/extensions/wallabyjs.console-ninja-1.0.399/out/buildHook/index.js').default({tool: 'webpack', checkSum: '20c449826605e5ba31a81dVhoNARYCDFIDVwBQBwRQCVVZBAFb', mode: 'build'}); } catch(cjsError) { try { import('file:///home/jr/.vscode/extensions/wallabyjs.console-ninja-1.0.399/out/buildHook/index.js').then(m => m.default.default({tool: 'webpack', checkSum: '20c449826605e5ba31a81dVhoNARYCDFIDVwBQBwRQCVVZBAFb', mode: 'build'})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */
